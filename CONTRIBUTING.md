...
https://metacpan.org/release/HTML-Differences

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends HTML::Differences
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends HTML::Differences
...
The code for this distribution is [hosted at GitHub](https://github.com/autarch/HTML-Differences).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=HTML-Differences)
or [via email](bug-html-differences@rt.cpan.org.
